    ...
    <footer className="py-16 px-6 lg:px-8 border-t border-border">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-muted leading-relaxed max-w-sm">
              ...
              trascienden. Diseño y construcción integral en Paraguay.
            </p>
            <div className="mt-6 space-y-2 text-sm text-muted">
              <p>Barrio Jara, Asunción, Paraguay</p>
              <p>+595 999 999 999</p>
              <p>contacto@efeconstructora.com.py</p>
            </div>
          </div>
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#25D366] text-white text-sm font-medium rounded-full hover:bg-[#1ebe5d] transition-colors mb-6"
            >
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-muted">Barrio Jara, Asunción, Paraguay</p>
        </div>
      </div>
    </footer>
  );
